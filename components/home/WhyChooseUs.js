...
// // // Small circular purple button with an arrow icon. dir="prev" mirrors the
// // // arrow horizontally instead of needing a second SVG.
...
// //       onClick={onClick}
// //       aria-label={label}
// //       className="flex h-11 w-11 items-center justify-center rounded-full bg-violet text-white shadow-lg shadow-violet/30 transition-transform active:scale-90"
// //     >
// //       <svg
// //         width="18"
// //         height="18"
...
// //       {/* mobile-only controls: circular purple prev/next buttons + a
// //           small dot indicator row, centered below the card. */}
...
//     // Lean into the shear fast (the "drag" kick), glide across the full
//     // distance, then let the lean settle back out with a soft overshoot
//     // for a fluid, elastic feel — all with zero vertical movement.
//     tl.to(track, { skewX: angle, duration: 0.16, ease: "power1.out" }, 0)
//       .to(track, { x: xForIndex(clamped), duration: 0.6, ease: "power3.inOut" }, 0)
//       .to(track, { skewX: 0, duration: 0.55, ease: "elastic.out(1, 0.75)" }, 0.16);
//   };
