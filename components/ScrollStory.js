    ...
    <>
      ...
      >
        <div className="relative z-10 max-w-4xl px-6 text-center">
          <span
            ref={eyebrowRef}
            className="mb-6 lg:inline-block md:inline-block hidden rounded-full border border-violet-dim px-4 py-1.5 font-mono text-[11px] tracking-[3px] text-violet opacity-0 font-semibold"
          >
            DIGITAL TRANSFORMATION AGENCY
          </span>
