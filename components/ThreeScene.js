...
// function getOrientationOffset() {
//   // Back to neutral — a previous 180°-Y guess made it face the wrong way.
//   // Test live with URL params instead of guessing blind:
//   //   ?ry=1.5708   (90° turn)
//   //   ?ry=-1.5708  (90° the other way)
//   //   ?ry=3.1416&rx=3.1416  (180° turn + flip, in case it's upside-down too)
//   // Once you find values that work, send them to me and I'll bake them in
//   // as the permanent default here.
//   const DEFAULT = { x: 0, y: 0, z: 0 };
...
//  *
//  * Loads the real model (/public/robot-head.glb). While it's downloading, a
...
//         const orientation = getOrientationOffset();
...
//       undefined,
//       (error) => {
//         console.error("robot-head.glb failed to load:", error);
//       }
//     );
