  ...
  return (
    <>
          ...
          <div className="flex h-16 items-center justify-between px-8">
            ...
            >
              <motion.button
                layout
                transition={{ type: "spring", stiffness: 180, damping: 22 }}
                className={`rounded-full border font-display text-[13px] tracking-wide border-violet bg-violet text-white ${
                  collapsed ? "px-4 py-1.5" : "px-5 py-2"
                }`}
              >
                <Link href={'/contact-us?mode=audit'}>
                  Technical Audit
                </Link>
              </motion.button>
              <motion.button
              ...
              >
                <Link href={'/contact-us?mode=contact'}>
                  Contact us
                </Link>
              </motion.button>
            </motion.div>
      ...
      <div className="fixed inset-x-4 top-3 z-50 flex items-center justify-between rounded-full border border-ink/10 bg-void/70 px-5 py-3 backdrop-blur-md lg:hidden">
        <Link href="/">
          <Image width={160} height={40} src="/logo2.png" alt="Kueaurex Solutions" className="h-6 w-auto" />
        </Link>
